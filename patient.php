...
<a href='newapppatient.php'class="button button1">New Appointment</button>
<a href='viewhistory.php'class="button button1">View History</button>
<a href='update_patient2.php'class="button button1">Update Info</button>
<a href='updateinsure.php'class="button button1">Update Insurance</button>
