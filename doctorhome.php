...
<a href='newpatient.html'class="button button1">New Patient</button>
<a href='findpatient.html'class="button button1">Find Patient</button>
<a href='update_patient.php'class="button button1">Update Information</button>
<a href='newappoint.php'class="button button1">New Appointment</button>
